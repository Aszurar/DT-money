...
**OBS**: Essa é a branch **```feature/localstorage```**, aqui é a versão publicada, feita com o localStorage e dados locais para facilitar, caso queira acessar a versão em que **simulamos uma API REST com json-server para consumir os dados**, vá na branch **[main](https://github.com/Aszurar/DT-money/tree/main)**.
